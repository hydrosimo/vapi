...
load ('zena-24/pluvio_r')     % mm, hourly rainfall                        % modify
pluvio = pluvio_r;

% Savena-24 (Pianoro)  % m_hg = 65
...
% Zena-24 (Bologna San Ruffillo)  % m_hg = 60
...
set(gca,'xtick',vxt,'ytick',vyt,'XMinorTick','on','YMinorTick','on');
ylabel(sprintf('intensity, i (mm h^{-1})'), 'Color', 'k');
% lgd = legend([h3; h2_rain23(1); h4; h2_rain24(1)],'T = 5 y','T = 10 y','T = 20 y','T = 50 y','T = 100 y','T = 200 y','T = 500 y','T = 1000 y','2023, i','2024, i','2024, i','Location','bestoutside','NumColumns',1);
